...
function search() {
    console.clear();
    const e = document.getElementById(search_input_id);
    if (!e) {
        console.log(`error: couldn't find the textbox with id '${search_input_id}' that should contain the search term.`);
        return;
    }
...
function search_recursive(e, term, regex) {
    var visible = false;
